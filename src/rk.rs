...
impl RKMethod for RK23 {
    ...
    fn c() -> ArrayView1<'static, f64> {
        lazy_static! {
            static ref C: Array1<f64> = array![1./2., 3./4.];
        }
        C.view()
    }
    ...
    fn b() -> ArrayView1<'static, f64> {
        lazy_static! {
            static ref B: Array1<f64> = array![2./9., 1./3., 4./9.];
        }
        B.view()
    }
    ...
    fn e() -> ArrayView1<'static, f64> {
        lazy_static! {
            static ref E: Array1<f64> = array![5./72., -1./12., -1./9., 1./8.];
        }
        E.view()
    }
...
impl RKMethod for RK45 {
    ...
    fn c() -> ArrayView1<'static, f64> {
        lazy_static! {
            static ref C: Array1<f64> = array![1./5., 3./10., 4./5., 8./9., 1.];
        }
        C.view()
    }
